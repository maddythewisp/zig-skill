...
- `-target`: The [target triple](48-targets.md#Targets) for the translated Zig code.
...
Demotion comes in three varieties - [opaque](19-opaque.md#opaque), *extern*, and
`@compileError`.
...
- Coerces to other pointer types, as well as [Optional Pointers](#Optional-Pointers).
  ...
  [Illegal Behavior](41-illegal-behavior.md#Illegal-Behavior) occurs if the address is 0.
- Allows address 0. On non-freestanding targets, dereferencing address 0 is safety-checked
  [Illegal Behavior](41-illegal-behavior.md#Illegal-Behavior). Optional C pointers introduce another bit to keep track of
...
- Does not support Zig-only pointer attributes such as alignment. Use normal [Pointers](14-pointers.md#Pointers)
  please!
...
Here is an example with the [Zig Build System](45-zig-build-system.md#Zig-Build-System):
