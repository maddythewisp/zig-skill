...
Unchecked Illegal Behavior still always results in a compile error if evaluated at [comptime](34-comptime.md#comptime), because the Zig
...
1/1 test_illegal_behavior.test.safety check...thread 3970806 panic: reached unreachable code
/home/ci/work/zig-bootstrap/zig/doc/langref/test_illegal_behavior.zig:2:5: 0x123a3fc in test.safety check (test_illegal_behavior.zig)
    unreachable;
    ^
/home/ci/work/zig-bootstrap/out/host/lib/zig/compiler/test_runner.zig:291:25: 0x11f4636 in mainTerminal (test_runner.zig)
        if (test_fn.func()) |_| {
...
/home/ci/work/zig-bootstrap/out/zig-local-cache/o/4b9367ab17dd2c039d3ca00fb314183c/test --seed=0xe852801b
...
thread 3974002 panic: reached unreachable code
/home/ci/work/zig-bootstrap/out/host/lib/zig/std/debug.zig:421:14: 0x1025eb9 in assert (std.zig)
    if (!ok) unreachable; // assertion failure
             ^
/home/ci/work/zig-bootstrap/zig/doc/langref/runtime_reaching_unreachable.zig:4:21: 0x11da8ee in main (runtime_reaching_unreachable.zig)
    std.debug.assert(false);
                    ^
...
thread 3974372 panic: index out of bounds: index 5, len 5
/home/ci/work/zig-bootstrap/zig/doc/langref/runtime_index_out_of_bounds.zig:7:13: 0x11da9ce in foo (runtime_index_out_of_bounds.zig)
    return x[5];
            ^
/home/ci/work/zig-bootstrap/zig/doc/langref/runtime_index_out_of_bounds.zig:2:18: 0x11da8fa in main (runtime_index_out_of_bounds.zig)
    const x = foo("hello");
                 ^
/home/ci/work/zig-bootstrap/out/host/lib/zig/std/start.zig:685:59: 0x11da211 in callMain (std.zig)
    if (fn_info.params.len == 0) return wrapMain(root.main());
...
thread 3972301 panic: integer does not fit in destination type
/home/ci/work/zig-bootstrap/zig/doc/langref/runtime_invalid_cast.zig:6:27: 0x11da8ff in main (runtime_invalid_cast.zig)
    const unsigned: u32 = @intCast(value);
                          ^
/home/ci/work/zig-bootstrap/out/host/lib/zig/std/start.zig:685:59: 0x11da211 in callMain (std.zig)
    if (fn_info.params.len == 0) return wrapMain(root.main());
...
thread 3973076 panic: integer does not fit in destination type
/home/ci/work/zig-bootstrap/zig/doc/langref/runtime_invalid_cast_truncate.zig:6:22: 0x11da900 in main (runtime_invalid_cast_truncate.zig)
    const byte: u8 = @intCast(spartan_count);
                     ^
/home/ci/work/zig-bootstrap/out/host/lib/zig/std/start.zig:685:59: 0x11da211 in callMain (std.zig)
    if (fn_info.params.len == 0) return wrapMain(root.main());
...
$ ./runtime_overflow
thread 3974164 panic: integer overflow
/home/ci/work/zig-bootstrap/zig/doc/langref/runtime_overflow.zig:5:10: 0x11da915 in main (runtime_overflow.zig)
    byte += 1;
         ^
/home/ci/work/zig-bootstrap/out/host/lib/zig/std/start.zig:685:59: 0x11da211 in callMain (std.zig)
    if (fn_info.params.len == 0) return wrapMain(root.main());
...
error: Overflow
/home/ci/work/zig-bootstrap/out/host/lib/zig/std/math.zig:565:21: 0x113e5d4 in add__anon_22439 (std.zig)
    if (ov[1] != 0) return error.Overflow;
                    ^
/home/ci/work/zig-bootstrap/zig/doc/langref/math_add.zig:8:9: 0x11d9d34 in main (math_add.zig)
        return err;
        ^
...
thread 3973998 panic: left shift overflowed bits
/home/ci/work/zig-bootstrap/zig/doc/langref/runtime_shlExact_overflow.zig:6:5: 0x11da921 in main (runtime_shlExact_overflow.zig)
    const y = @shlExact(x, 2);
    ^
/home/ci/work/zig-bootstrap/out/host/lib/zig/std/start.zig:685:59: 0x11da211 in callMain (std.zig)
    if (fn_info.params.len == 0) return wrapMain(root.main());
...
thread 3971436 panic: right shift overflowed bits
/home/ci/work/zig-bootstrap/zig/doc/langref/runtime_shrExact_overflow.zig:7:5: 0x11da90a in main (runtime_shrExact_overflow.zig)
    const y = @shrExact(x, 2);
    ^
/home/ci/work/zig-bootstrap/out/host/lib/zig/std/start.zig:685:59: 0x11da211 in callMain (std.zig)
    if (fn_info.params.len == 0) return wrapMain(root.main());
...
thread 3972357 panic: division by zero
/home/ci/work/zig-bootstrap/zig/doc/langref/runtime_division_by_zero.zig:7:17: 0x11da910 in main (runtime_division_by_zero.zig)
    const c = a / b;
                ^
/home/ci/work/zig-bootstrap/out/host/lib/zig/std/start.zig:685:59: 0x11da211 in callMain (std.zig)
    if (fn_info.params.len == 0) return wrapMain(root.main());
...
thread 3971753 panic: division by zero
/home/ci/work/zig-bootstrap/zig/doc/langref/runtime_remainder_division_by_zero.zig:7:17: 0x11da910 in main (runtime_remainder_division_by_zero.zig)
    const c = a % b;
                ^
/home/ci/work/zig-bootstrap/out/host/lib/zig/std/start.zig:685:59: 0x11da211 in callMain (std.zig)
    if (fn_info.params.len == 0) return wrapMain(root.main());
...
thread 3971550 panic: exact division produced remainder
/home/ci/work/zig-bootstrap/zig/doc/langref/runtime_divExact_remainder.zig:7:15: 0x11da945 in main (runtime_divExact_remainder.zig)
    const c = @divExact(a, b);
              ^
/home/ci/work/zig-bootstrap/out/host/lib/zig/std/start.zig:685:59: 0x11da211 in callMain (std.zig)
    if (fn_info.params.len == 0) return wrapMain(root.main());
...
$ ./runtime_unwrap_null
thread 3971049 panic: attempt to use null value
/home/ci/work/zig-bootstrap/zig/doc/langref/runtime_unwrap_null.zig:6:35: 0x11da914 in main (runtime_unwrap_null.zig)
    const number = optional_number.?;
                                  ^
/home/ci/work/zig-bootstrap/out/host/lib/zig/std/start.zig:685:59: 0x11da211 in callMain (std.zig)
    if (fn_info.params.len == 0) return wrapMain(root.main());
...
thread 3974511 panic: attempt to unwrap error: UnableToReturnNumber
error return context:
/home/ci/work/zig-bootstrap/zig/doc/langref/runtime_unwrap_error.zig:9:5: 0x11da8ec in getNumberOrFail (runtime_unwrap_error.zig)
    return error.UnableToReturnNumber;
    ^

stack trace:
/home/ci/work/zig-bootstrap/zig/doc/langref/runtime_unwrap_error.zig:4:44: 0x11da953 in main (runtime_unwrap_error.zig)
    const number = getNumberOrFail() catch unreachable;
                                           ^
/home/ci/work/zig-bootstrap/out/host/lib/zig/std/start.zig:685:59: 0x11da211 in callMain (std.zig)
    if (fn_info.params.len == 0) return wrapMain(root.main());
...
thread 3974302 panic: invalid error code
/home/ci/work/zig-bootstrap/zig/doc/langref/runtime_invalid_error_code.zig:7:5: 0x11da927 in main (runtime_invalid_error_code.zig)
    const invalid_err = @errorFromInt(number);
    ^
/home/ci/work/zig-bootstrap/out/host/lib/zig/std/start.zig:685:59: 0x11da211 in callMain (std.zig)
    if (fn_info.params.len == 0) return wrapMain(root.main());
...
thread 3973904 panic: invalid enum value
/home/ci/work/zig-bootstrap/zig/doc/langref/runtime_invalid_enum_cast.zig:12:20: 0x11da970 in main (runtime_invalid_enum_cast.zig)
    const b: Foo = @enumFromInt(a);
                   ^
/home/ci/work/zig-bootstrap/out/host/lib/zig/std/start.zig:685:59: 0x11da211 in callMain (std.zig)
    if (fn_info.params.len == 0) return wrapMain(root.main());
...
thread 3973373 panic: invalid error code
/home/ci/work/zig-bootstrap/zig/doc/langref/runtime_invalid_error_set_cast.zig:15:21: 0x11da9ec in foo (runtime_invalid_error_set_cast.zig)
    const x: Set2 = @errorCast(set1);
                    ^
/home/ci/work/zig-bootstrap/zig/doc/langref/runtime_invalid_error_set_cast.zig:12:8: 0x11da8f7 in main (runtime_invalid_error_set_cast.zig)
    foo(Set1.B);
       ^
/home/ci/work/zig-bootstrap/out/host/lib/zig/std/start.zig:685:59: 0x11da211 in callMain (std.zig)
    if (fn_info.params.len == 0) return wrapMain(root.main());
...
thread 3972867 panic: incorrect alignment
/home/ci/work/zig-bootstrap/zig/doc/langref/runtime_incorrect_pointer_alignment.zig:9:64: 0x11db266 in foo (runtime_incorrect_pointer_alignment.zig)
    const int_slice = mem.bytesAsSlice(u32, @as([]align(4) u8, @alignCast(slice4)));
                                                               ^
/home/ci/work/zig-bootstrap/zig/doc/langref/runtime_incorrect_pointer_alignment.zig:5:12: 0x11d9cce in main (runtime_incorrect_pointer_alignment.zig)
    if (foo(bytes) != 0x11111111) return error.Wrong;
           ^
/home/ci/work/zig-bootstrap/out/host/lib/zig/std/start.zig:685:59: 0x11da2bc in callMain (std.zig)
    if (fn_info.params.len == 0) return wrapMain(root.main());
                                                          ^
/home/ci/work/zig-bootstrap/out/host/lib/zig/std/start.zig:190:5: 0x11d9c71 in _start (std.zig)
    asm volatile (switch (native_arch) {
...
thread 3971548 panic: access of union field 'float' while field 'int' is active
/home/ci/work/zig-bootstrap/zig/doc/langref/runtime_wrong_union_field_access.zig:14:6: 0x11da9be in bar (runtime_wrong_union_field_access.zig)
    f.float = 12.34;
     ^
/home/ci/work/zig-bootstrap/zig/doc/langref/runtime_wrong_union_field_access.zig:10:8: 0x11da8fe in main (runtime_wrong_union_field_access.zig)
    bar(&f);
       ^
/home/ci/work/zig-bootstrap/out/host/lib/zig/std/start.zig:685:59: 0x11da211 in callMain (std.zig)
    if (fn_info.params.len == 0) return wrapMain(root.main());
...
thread 3971823 panic: integer part of floating point value out of bounds
/home/ci/work/zig-bootstrap/zig/doc/langref/runtime_out_of_bounds_float_to_integer_cast.zig:4:22: 0x11da92f in main (runtime_out_of_bounds_float_to_integer_cast.zig)
    const int: i32 = @intFromFloat(float);
                     ^
/home/ci/work/zig-bootstrap/out/host/lib/zig/std/start.zig:685:59: 0x11da211 in callMain (std.zig)
    if (fn_info.params.len == 0) return wrapMain(root.main());
...
For example, [C Pointers](46-c.md#C-Pointers), [Optional Pointers](#Optional-Pointers), and [allowzero](#allowzero) pointers
allow address zero, but normal [Pointers](14-pointers.md#Pointers) do not.
...
thread 3973168 panic: cast causes pointer to be null
/home/ci/work/zig-bootstrap/zig/doc/langref/runtime_invalid_null_pointer_cast.zig:4:23: 0x11da90a in main (runtime_invalid_null_pointer_cast.zig)
    const ptr: *i32 = @ptrCast(opt_ptr);
                      ^
/home/ci/work/zig-bootstrap/out/host/lib/zig/std/start.zig:685:59: 0x11da211 in callMain (std.zig)
    if (fn_info.params.len == 0) return wrapMain(root.main());
