...
known size, and is vulnerable to safety-checked [Illegal Behavior](41-illegal-behavior.md#Illegal-Behavior).
...
Operators such as `+` and `-` cause [Illegal Behavior](41-illegal-behavior.md#Illegal-Behavior) on
